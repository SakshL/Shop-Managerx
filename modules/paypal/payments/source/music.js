module.exports = (client, app, paypal, webConfig, logChannel) => {
    ...
    app.post('/pay/source/music', (req, res) => {
        const create_payment_json = {
            ...
            "redirect_urls": {
                "return_url": `${webConfig.domain}/success/source/music`,
                "cancel_url": `${webConfig.domain}/cancel`
            },
            "transactions": [{
                "item_list": {
                    "items": [{
                        "name": `Music Bot Source Code`,
                        "sku": `204`,
                        "price": `25.00`,
                        "currency": `EUR`,
                        "quantity": 1
                ...
                "description": `Music Bot Source Code`
            }]
        };
    ...
    app.get('/success/source/music', (req, res) => {
        ...
        paypal.payment.execute(paymentId, execute_payment_json, function (error, payment) {
          if (error) {
              ...
              res.sendFile(`${process.cwd()}/modules/paypal/success/source/music.html`)
          }
      });
    });
}