module.exports = (client, app, paypal, webConfig, logChannel) => {
    ...
    app.post('/pay/source/waitingroom', (req, res) => {
        const create_payment_json = {
            ...
            "redirect_urls": {
                "return_url": `${webConfig.domain}/success/source/waitingroom`,
                "cancel_url": `${webConfig.domain}/cancel`
            },
            "transactions": [{
                "item_list": {
                    "items": [{
                        "name": `Waitingroom Bot Source Code`,
                        "sku": `205`,
                        "price": `25.00`,
                        "currency": `EUR`,
                        "quantity": 1
                ...
                "description": `Waitingroom Bot Source Code`
            }]
        };
    ...
    app.get('/success/source/waitingroom', (req, res) => {
        ...
        paypal.payment.execute(paymentId, execute_payment_json, function (error, payment) {
          if (error) {
              ...
              res.sendFile(`${process.cwd()}/modules/paypal/success/source/waitingroom.html`)
          }
      });
    });
}