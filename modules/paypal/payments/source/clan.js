module.exports = (client, app, paypal, webConfig, logChannel) => {
    ...
    app.post('/pay/source/clan', (req, res) => {
        const create_payment_json = {
            ...
            "redirect_urls": {
                "return_url": `${webConfig.domain}/success/source/clan`,
                "cancel_url": `${webConfig.domain}/cancel`
            },
            "transactions": [{
                "item_list": {
                    "items": [{
                        "name": `Clan Bot Source Code`,
                        "sku": `202`,
                        "price": `75.00`,
                        "currency": `EUR`,
                        "quantity": 1
                ...
                "description": `Clan Bot Source Code`
            }]
        };
    ...
    app.get('/success/source/clan', (req, res) => {
        ...
        paypal.payment.execute(paymentId, execute_payment_json, function (error, payment) {
          if (error) {
              ...
              res.sendFile(`${process.cwd()}/modules/paypal/success/source/clan.html`)
          }
      });
    });
}