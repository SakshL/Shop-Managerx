module.exports = (client, app, paypal, webConfig, logChannel) => {
    ...
    app.post('/pay/yearlyhosted/music', (req, res) => {
        const create_payment_json = {
            ...
            "redirect_urls": {
                "return_url": `${webConfig.domain}/success/yearlyhosted/music`,
                "cancel_url": `${webConfig.domain}/cancel`
            },
            "transactions": [{
                "item_list": {
                    "items": [{
                        "name": `Music Bot Yearly Hosted`,
                        "sku": `304`,
                        "price": `7.50`,
                        "currency": `EUR`,
                        "quantity": 1
                ...
                "description": `Music Bot Yearly Hosted`
            }]
        };
    ...
    app.get('/success/yearlyhosted/music', (req, res) => {
        ...
        paypal.payment.execute(paymentId, execute_payment_json, function (error, payment) {
          if (error) {
              ...
              res.sendFile(`${process.cwd()}/modules/paypal/success/yearlyhosted/music.html`)
          }
      });
    });
}