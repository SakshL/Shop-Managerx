module.exports = (client, app, paypal, webConfig, logChannel) => {
    ...
    app.post('/pay/monthlyhosted/modmail', (req, res) => {
        const create_payment_json = {
            ...
            "redirect_urls": {
                "return_url": `${webConfig.domain}/success/monthlyhosted/modmail`,
                "cancel_url": `${webConfig.domain}/cancel`
            },
            "transactions": [{
                "item_list": {
                    "items": [{
                        "name": `Modmail Bot Monthly Hosted`,
                        "sku": `303`,
                        "price": `0.50`,
                        "currency": `EUR`,
                        "quantity": 1
                ...
                "description": `Modmail Bot Monthly Hosted`
            }]
        };
    ...
    app.get('/success/monthlyhosted/modmail', (req, res) => {
        ...
        paypal.payment.execute(paymentId, execute_payment_json, function (error, payment) {
          if (error) {
              ...
              res.sendFile(`${process.cwd()}/modules/paypal/success/monthlyhosted/modmail.html`)
          }
      });
    });
}