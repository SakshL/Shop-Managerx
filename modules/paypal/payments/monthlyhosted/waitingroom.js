module.exports = (client, app, paypal, webConfig, logChannel) => {
    ...
    app.post('/pay/monthlyhosted/waitingroom', (req, res) => {
        const create_payment_json = {
            ...
            "redirect_urls": {
                "return_url": `${webConfig.domain}/success/monthlyhosted/waitingroom`,
                "cancel_url": `${webConfig.domain}/cancel`
            },
            "transactions": [{
                "item_list": {
                    "items": [{
                        "name": `Waitingroom Bot Monthly Hosted`,
                        "sku": `305`,
                        "price": `1.00`,
                        "currency": `EUR`,
                        "quantity": 1
                ...
                "description": `Waitingroom Bot Monthly Hosted`
            }]
        };
    ...
    app.get('/success/monthlyhosted/waitingroom', (req, res) => {
        ...
        paypal.payment.execute(paymentId, execute_payment_json, function (error, payment) {
          if (error) {
              ...
              res.sendFile(`${process.cwd()}/modules/paypal/success/monthlyhosted/waitingroom.html`)
          }
      });
    });
}